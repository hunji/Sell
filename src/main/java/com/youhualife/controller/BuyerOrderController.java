...
import com.youhualife.form.OrderForm;
import com.youhualife.service.BuyerService;
...
public class BuyerOrderController {
    ...
    public ResultVO<Map<String, String>> create(@RequestBody @Valid OrderForm orderForm,
        ...
        orderDTO.setOrderDetailList(orderForm.getItems().stream()
                .map(c -> {
                    OrderDetail orderDetail = new OrderDetail();
                    orderDetail.setProductId(c.getProductId());
                    orderDetail.setProductQuantity(c.getProductQuantity());
                    return orderDetail;
